export function Footer() {
  return (
    <footer className="py-12 bg-green-500">
      <div className="justify-center flex flex-col items-center">
        <img src="/images/footer-logo.svg" alt="" color="" className="mb-8" />
        <div className="flex items-center justify-center space-x-6 mx-auto">
          <a
            href="#"
            className="capitalize text-lg hover:text-white font-barlow text-green-800"
          >
            About
          </a>
          <a
        ...
        <div className="flex items-center justify-center mt-6 space-x-6 mx-auto">
          <a
            href="#"
            className="capitalize  hover:text-white text-green-800 group"
          >
            <svg
              width="20"
              height="20"
          ...
          <a href="#" className="hover:text-white text-green-800 group">
